...
2. Run the report command by using `npm run test:cli`. By default looks in `reports/` directory for report json files. You can also specify the **output** directory which by default is `historic-reports-by-scenario.html`.
